...
static int __RVC_SPEC1_DRIVERENTER[] = {-1,3, 4, 4, 4, };
static int __RVC_SPEC1_DRIVE[] = {-1,2, 2, 4, 2, };
static int __RVC_SPEC1_CREATECAR[] = {1, 4, 4, 4, 4, };
...
__RVC_state = __RVC_SPEC1_CREATECAR[__RVC_state];
  __RVC_Spec1_match = __RVC_state == 2;
if(__RVC_Spec1_match)
{
{
